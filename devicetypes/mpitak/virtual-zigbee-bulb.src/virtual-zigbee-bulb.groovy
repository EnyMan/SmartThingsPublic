/**
 *  Virtual ZigBee Bulb (Used for Ladvance light groups)
 *
 ...
 *  Date: 2016-01-19
 *
 *  This DTH should serve as the generic DTH to handle White Adjustable ZigBee HA devices
 */

metadata {
    definition (name: "Virtual ZigBee Bulb", namespace: "mpitak", author: "Martin Pitak") {
        capability "Actuator"
        capability "Refresh"
        capability "Switch"
